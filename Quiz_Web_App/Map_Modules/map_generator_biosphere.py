...
def generate_map():
    ...
    for item in name_list:
        ...
        html="<div style=\"@import url('https://fonts.googleapis.com/css?family=Roboto+Condensed');font-family: 'Roboto Condensed', sans-serif;\">"+"<h5>"+item+"</h5>"+"<p style=\"font-size: 12px\">Location: "+location+"</>"+"<p style=\"font-size: 12px\">Classification: "+type+"</>"+"<p style=\"font-size: 12px\">Key Fauna: "+key_fauna+"</>"+"</div>"
    ...
    m.save(f'map_biosphere_reserves.html')
